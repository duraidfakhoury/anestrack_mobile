import 'package:anestrack_mobile/core/enum/request_status.dart';
...
///
///  in your [Bloc] states you can use this class in following way:
...
class BaseState<T> extends Equatable {
  ...
  // null data
  BaseState<T> dataNull({RequestStatus? requestStatus, Failure? failure}) {
    return BaseState<T>(
      data: null,
      requestStatus: requestStatus ?? this.requestStatus,
      failure: failure ?? this.failure,
